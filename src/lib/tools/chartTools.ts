...
import { PieChart, Pie, Cell, Tooltip, Legend, BarChart, Bar, XAxis, YAxis, CartesianGrid, ScatterChart, Scatter, ZAxis, LineChart, Line } from "recharts";
...
export const chartTools: MathTool[] = [
  ...
  },
  {
    ...
    category: "Charts & Graphs",
    classLevel: "Class 8",
    description: "Generate a line chart from categories and values.",
    inputs: [
      {
        id: "categories",
        label: "Categories (comma separated)",
    ...
    calculate: (values) => {
      try {
        ...
        return {
          result: chart,
          steps: ["Parsed categories and values.", "Generated Line Chart."],
        };
      } catch (e) {
        return { result: "Invalid input." };
      }
